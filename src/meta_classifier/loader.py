...
MODEL_CONFIGS = {
    ...
    "retina": {
        ...
        "input_shape": (224, 224, 3),
        "num_classes": 5,
        "ensemble_weights": [0.333, 0.329, 0.338],  # Based on QWK scores
    },
}
...
class ModelLoader:
    ...
    Usage:
        ...
        preprocess = loader.load_preprocessing_config("brain_mri")
    """
    ...
    def load_model(self, disease_type: str, model_key: Optional[str] = None) -> tf.keras.Model:
        ...
        Args:
            ...
            model_key: For retina ensemble, specify which model (e.g., "efficientnetv2s")
